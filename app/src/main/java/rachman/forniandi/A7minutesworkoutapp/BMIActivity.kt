...
import rachman.forniandi.A7minutesworkoutapp.databinding.ActivityBmiBinding
...
class BMIActivity : AppCompatActivity() {
    ...
    private fun calculateUnits(){
        if (currentVisibleView == METRIC_UNITS_VIEW){
            ...
            if (validateUsUnits()){
                val usUnitsHeightValuesFeet:String = binding?.etUsMetricUnitWeight?.text.toString()
                ...
                val heightValue = usUnitHeightValueInch.toFloat() + usUnitsHeightValuesFeet.toFloat()*12

                val bmiUs = 703 *(usUnitWeightValue /(heightValue*heightValue))
